package com.github.myth.spring.boot.starter.springcloud.configuration;
...
import com.github.myth.spring.boot.starter.springcloud.config.MythConfigProperties;
...
public class MythSpringcloudAutoConfiguration {

    private final MythConfigProperties mythConfigProperties;

    @Autowired
    public MythSpringcloudAutoConfiguration(MythConfigProperties mythConfigProperties) {
