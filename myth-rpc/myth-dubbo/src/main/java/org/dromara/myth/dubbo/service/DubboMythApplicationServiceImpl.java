...
package org.dromara.myth.dubbo.service;
...
public class DubboMythApplicationServiceImpl implements MythApplicationService {
    ...
    /**
     * Instantiates a new Dubbo myth application service.
     *
     * @param applicationConfig the application config
     */
    @Autowired(required = false)
    public DubboMythApplicationServiceImpl(final ApplicationConfig applicationConfig) {
